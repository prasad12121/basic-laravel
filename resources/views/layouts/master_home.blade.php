...
<head>
    ...
    <link href="{{asset('/assets/vendor/boxicons/css/boxicons.min.css')}}fontend" rel="stylesheet">
    <link href="{{asset('/assets/vendor/boxicons/css/boxicons.min.css')}}fontendx" rel="stylesheet">
